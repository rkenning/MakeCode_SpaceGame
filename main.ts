...
ship = sprites.create(assets.image`ShipRight`, SpriteKind.Player)
...
game.onUpdateInterval(500, function on_update_interval() {
    projectile = sprites.createProjectileFromSide(asteroids[randint(0, asteroids.length - 1)], 0, 30)
    projectile.setKind(SpriteKind.Enemy)
    projectile.x = randint(10, 150)
    animation.runImageAnimation(ship, assets.animation`ShipAnim`, 50)
})
